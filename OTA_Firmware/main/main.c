...
void run_ota(void *params)
{
    ...
    esp_http_client_config_t clientConfig = {
        // .url = "http://172.19.144.253:8070/OTA_Firmware.bin",
        .url = "https://drive.usercontent.google.com/u/0/uc?id=198bVN7BFhTYXZ4I5GD97SHNc5309l4r7&export=download" ,// our ota location
